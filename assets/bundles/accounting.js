...
var tracking = __webpack_require__(21);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__accounting_compound_transaction__ = __webpack_require__(55);
...
if (transactionTable) {
    __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__accounting_compound_transaction__["a" /* default */], null), transactionTable);
}
...
class TransactionTable extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    constructor(props) {
        super(props);
        this.state = {
            contents: [],
    ...
    render() {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Content, { contents: this.state.contents,
                removeHandler: this.removeHandler.bind(this) }),
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(EntryRow, { addHandler: this.addHandler.bind(this),
                balanced: this.state.balanced })
        );
    }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = TransactionTable;
...
class Content extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    render() {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'tbody',
            null,
            this.props.contents.map((item, index) => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'tr',
                { key: index },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'td',
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'td',
                    null,
                    item.debit === "1" ? 'Debit' : 'Credit'
                )
            ))
        );
    }
}
class EntryRow extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    constructor(props) {
        super(props);
        this.state = {
            accounts: [],
    ...
    addHandler() {
        if (this.state.inputs.account === "" || this.state.inputs.amount === 0 || this.state.inputs.debit === "") {
    ...
    render() {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        this.state.accounts.map((acc, index) => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'option',
                            { key: index, value: acc.id },
                            ' ',
                            acc.name
                        ))
                    )
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'td',
                    null,
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { name: 'amount',
                        type: 'number',
                        className: 'form-control',
                        onChange: this.handleInputChange.bind(this) })
                ),
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'tr',
                { className: this.props.balanced === 1 ? "bg-success" : "bg-danger" },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'td',
                    { colSpan: 3, style: {
                            fontSize: "24",
                    ...
                    this.props.balanced === 1 ? "Balanced" : "Unbalanced"
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'td',
                    null,
