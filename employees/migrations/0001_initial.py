    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automate_payroll_for', models.ManyToManyField(blank=True, to='employees.Employee')),
                ('payroll_officer', models.ForeignKey(blank=True, null=True, on_delete=None, related_name='payroll_officer', to='employees.Employee')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recorded_by', models.ForeignKey(null=True, on_delete=None, related_name='recorder', to='employees.Employee')),
            ],
        ),
        migrations.CreateModel(
            name='PayGrade',
