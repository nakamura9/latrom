...
personnel_urls = [
    re_path(r'^service-person-create/?$', views.ServicePersonCreateView.as_view(), 
    ...
    re_path(r'^team-create/?$', views.ServiceTeamCreateView.as_view(), 
        name='team-create'),
    re_path(r'^team-update/(?P<pk>\d+)/?$', views.ServiceTeamUpdateView.as_view(), 
        name='team-update'),
    re_path(r'^team-detail/(?P<pk>\d+)/?$', views.ServiceTeamDetailView.as_view(), 
        name='team-detail'),
    re_path(r'^team-list/?$', views.ServiceTeamListView.as_view(), name='team-list'),
