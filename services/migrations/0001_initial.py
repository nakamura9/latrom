    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actual_duration', models.DurationField(blank=True, choices=[(datetime.timedelta(0), '00:00'), (datetime.timedelta(0, 1800), '00:30'), (datetime.timedelta(0, 3600), '01:00'), (datetime.timedelta(0, 5400), '01:30'), (datetime.timedelta(0, 7200), '02:00'), (datetime.timedelta(0, 9000), '02:30'), (datetime.timedelta(0, 10800), '03:00'), (datetime.timedelta(0, 12600), '03:30'), (datetime.timedelta(0, 14400), '04:00'), (datetime.timedelta(0, 16200), '04:30'), (datetime.timedelta(0, 18000), '05:00'), (datetime.timedelta(0, 19800), '05:30'), (datetime.timedelta(0, 21600), '06:00'), (datetime.timedelta(0, 23400), '06:30'), (datetime.timedelta(0, 25200), '07:00'), (datetime.timedelta(0, 27000), '07:30')], null=True)),
                ...
                ('authorized_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='employees.Employee')),
