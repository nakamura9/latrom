    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adjusted_by', models.ForeignKey(on_delete=None, to='employees.Employee')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('controller', models.ForeignKey(on_delete=None, to='employees.Employee')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=None, to='inventory.Order')),
                ('received_by', models.ForeignKey(default=1, on_delete=None, to='employees.Employee')),
            ],
        ),
        migrations.CreateModel(
            name='StorageMedia',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issuing_inventory_controller', models.ForeignKey(null=True, on_delete=None, related_name='issuing_inventory_controller', to='employees.Employee')),
                ('receiving_inventory_controller', models.ForeignKey(null=True, on_delete=None, to='employees.Employee')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('width', models.FloatField(default=0.0)),
                ('height', models.FloatField(default=0.0)),
                ('inventory_controller', models.ForeignKey(blank=True, null=True, on_delete=None, to='employees.Employee')),
            ],
        ),
        migrations.CreateModel(
            name='WareHouseItem',
